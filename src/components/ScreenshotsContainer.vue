<template>
    <section id ="screenshots" class=" flex flex-col items-center border-b-2 border-slate-800 pt-16 p-8">
        <h3 class="text-3xl text-center font-bold pb-8">Screenshots</h3>
