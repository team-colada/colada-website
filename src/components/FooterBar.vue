<template>
    <footer class="footer-bar flex md:justify-between justify-center items-center bg-slate-800 md:p-0 pt-4 pb-4">
        <div class="footer-left md:flex md:justify-center md:items-center md:w-auto hidden gap-3 pl-4">
            ...
            <a href="#features" class="text-slate-500 hover:text-slate-400">Features</a>
            <a href="#install" class="text-slate-500 hover:text-slate-400">Installation</a>
            <a href="#contributors" class="text-slate-500 hover:text-slate-400">Contributors</a>
        </div>
        <div class="footer-right flex justify-start items-center pr-4 gap-2">
            <h1>© 2022 Colada | MIT License</h1>
